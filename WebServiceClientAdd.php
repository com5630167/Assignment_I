...
?>
<input type="button" id="BACK" value="BACK" onclick="location.href = 'http://ec2-35-161-100-152.us-west-2.compute.amazonaws.com/topic/index.html';" class="btn btn-default"/>
<!-- ADD SERVICE -->
<h1> Add Book By Name Service </h1>
<?php
  	if($_POST['submit_add'] == "Submit") {
        $client = new nusoap_client("http://ec2-35-161-100-152.us-west-2.compute.amazonaws.com/topic/WebServiceServer.php?wsdl",true); 
		$add = array(
